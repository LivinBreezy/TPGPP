...
bool MultiplyOperation::execute(int8 mode, int32 source, int8 destination,
...
std::string MultiplyOperation::toString() const
{
    return std::string("mul");
}

std::string MultiplyOperation::toStorage() const
{
